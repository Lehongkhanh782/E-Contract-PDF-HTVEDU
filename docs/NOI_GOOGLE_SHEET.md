...
Ghi kèm chữ cho biết đã qua thử việc thì hệ thống hiểu là **đã xong**,
không còn là thử việc nữa: `THU_VIEC_XONG`, `Đã thử việc xong`, `Hết thử
việc`, `Thử việc - đã ký chính thức`.

Ô để trống hoặc ghi chữ lạ thì coi là **chính thức**. Chỗ này cố ý làm
ngược với cột trạng thái nghỉ việc: ở đó không rõ thì giữ người lại cho
